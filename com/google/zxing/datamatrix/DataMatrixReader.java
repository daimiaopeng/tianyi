  ...
  implements Reader
{
  ...
  public Result decode(BinaryBitmap paramBinaryBitmap, Map<DecodeHintType, ?> paramMap)
  {
    ...
    {
      DetectorResult localDetectorResult = new Detector(paramBinaryBitmap.getBlackMatrix()).detect();
    ...
    Result localResult = new Result(((DecoderResult)localObject).getText(), ((DecoderResult)localObject).getRawBytes(), arrayOfResultPoint, BarcodeFormat.DATA_MATRIX);
