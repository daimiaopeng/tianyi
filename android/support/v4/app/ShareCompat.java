...
public final class ShareCompat
{
  ...
  public static void configureMenuItem(Menu paramMenu, int paramInt, IntentBuilder paramIntentBuilder)
  {
    ...
    if (localMenuItem == null)
    {
      ...
      localStringBuilder.append("Could not find menu item with id ");
      localStringBuilder.append(paramInt);
      localStringBuilder.append(" in the supplied menu");
  ...
  public static void configureMenuItem(MenuItem paramMenuItem, IntentBuilder paramIntentBuilder)
  {
    ...
    ShareActionProvider localShareActionProvider;
    if (!(localActionProvider instanceof ShareActionProvider))
      localShareActionProvider = new ShareActionProvider(paramIntentBuilder.getActivity());
    else
      localShareActionProvider = (ShareActionProvider)localActionProvider;
    StringBuilder localStringBuilder = new StringBuilder();
    localStringBuilder.append(".sharecompat_");
    localStringBuilder.append(paramIntentBuilder.getActivity().getClass().getName());
    localShareActionProvider.setShareHistoryFileName(localStringBuilder.toString());
  ...
  public static class IntentBuilder
  {
    ...
    public Intent getIntent()
    {
      ...
      int i = 1;
      if ((localArrayList == null) || (this.mStreams.size() <= i))
        i = 0;
  ...
  public static class IntentReader
  {
    ...
    public String getHtmlText()
    {
      ...
      if (str == null)
      {
        ...
        else if (localCharSequence != null)
          if (Build.VERSION.SDK_INT >= 16)
          {
            str = Html.escapeHtml(localCharSequence);
          }
          else
          {
            StringBuilder localStringBuilder = new StringBuilder();
