  ...
  implements q, ActivityCompat.OnRequestPermissionsResultCallback, ActivityCompat.RequestPermissionsRequestCodeValidator
{
  ...
  private static boolean markState(FragmentManager paramFragmentManager, c.b paramb)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      {
        if (localFragment.getLifecycle().a().a(c.b.d))
        {
          localFragment.mLifecycleRegistry.a(paramb);
          bool = true;
        }
        FragmentManager localFragmentManager = localFragment.peekChildFragmentManager();
        if (localFragmentManager != null)
          bool |= markState(localFragmentManager, paramb);
      }
    }
    return bool;
  }
  ...
  protected void onActivityResult(int paramInt1, int paramInt2, @Nullable Intent paramIntent)
  {
    ...
    if (i != 0)
    {
      ...
      {
        StringBuilder localStringBuilder = new StringBuilder();
        localStringBuilder.append("Activity result no fragment exists for who: ");
        localStringBuilder.append(str);
        Log.w("FragmentActivity", localStringBuilder.toString());
      }
      else
      {
    ...
    ActivityCompat.PermissionCompatDelegate localPermissionCompatDelegate = ActivityCompat.getPermissionCompatDelegate();
    if ((localPermissionCompatDelegate != null) && (localPermissionCompatDelegate.onActivityResult(this, paramInt1, paramInt2, paramIntent)))
      return;
  ...
  void requestPermissionsFromFragment(Fragment paramFragment, String[] paramArrayOfString, int paramInt)
  {
    ...
    try
    {
      ...
      ActivityCompat.requestPermissions(this, paramArrayOfString, (1 + allocateRequestIndex(paramFragment) << 16) + (paramInt & 0xFFFF));
      return;
    }
    finally
    {
  ...
  public void startActivityFromFragment(Fragment paramFragment, Intent paramIntent, int paramInt, @Nullable Bundle paramBundle)
  {
    ...
    checkForValidRequestCode(paramInt);
    ActivityCompat.startActivityForResult(this, paramIntent, (1 + allocateRequestIndex(paramFragment) << 16) + (paramInt & 0xFFFF), paramBundle);
    this.mStartedActivityFromFragment = false;
    return;
    label62: this.mStartedActivityFromFragment = false;
    throw localObject;
  }
  ...
  public void startIntentSenderFromFragment(Fragment paramFragment, IntentSender paramIntentSender, int paramInt1, @Nullable Intent paramIntent, int paramInt2, int paramInt3, int paramInt4, Bundle paramBundle)
  {
    ...
    this.mStartedIntentSenderFromFragment = false;
    return;
    label78: this.mStartedIntentSenderFromFragment = false;
    throw localObject;
  }
  ...
  class HostCallbacks extends FragmentHostCallback<FragmentActivity>
  {
    ...
    {
      return true ^ FragmentActivity.this.isFinishing();
    }
