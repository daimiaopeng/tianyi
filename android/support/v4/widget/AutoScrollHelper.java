  ...
  implements View.OnTouchListener
{
  ...
  private float getEdgeValue(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4)
  {
    ...
    if (f3 < 0.0F)
    {
      f4 = -this.mEdgeInterpolator.getInterpolation(-f3);
    }
    else
    {
      if (f3 <= 0.0F)
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    boolean bool1 = this.mExclusive;
    boolean bool2 = false;
    if (bool1)
    {
      boolean bool3 = this.mAnimating;
      bool2 = false;
      if (bool3)
        bool2 = true;
    }
  ...
  private static class ClampedScroller
  {
    ...
    {
      return paramFloat * (-4.0F * paramFloat) + paramFloat * 4.0F;
    }
    ...
    public void computeScrollDelta()
    {
      ...
      float f1 = interpolateValue(getValueAt(l1));
      long l2 = l1 - this.mDeltaTime;
      this.mDeltaTime = l1;
      float f2 = f1 * (float)l2;
      this.mDeltaX = (int)(f2 * this.mTargetVelocityX);
