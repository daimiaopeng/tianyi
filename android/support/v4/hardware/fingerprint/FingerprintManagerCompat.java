  ...
  public void authenticate(@Nullable CryptoObject paramCryptoObject, int paramInt, @Nullable android.support.v4.os.CancellationSignal paramCancellationSignal, @NonNull AuthenticationCallback paramAuthenticationCallback, @Nullable Handler paramHandler)
  {
    if (Build.VERSION.SDK_INT >= 23)
    {
      ...
      if (localFingerprintManager != null)
      {
        ...
        android.os.CancellationSignal localCancellationSignal2;
        for (android.os.CancellationSignal localCancellationSignal1 = (android.os.CancellationSignal)paramCancellationSignal.getCancellationSignalObject(); ; localCancellationSignal1 = null)
        {
          localCancellationSignal2 = localCancellationSignal1;
          break;
        }
        localFingerprintManager.authenticate(wrapCryptoObject(paramCryptoObject), localCancellationSignal2, paramInt, wrapCallback(paramAuthenticationCallback), paramHandler);
      }
    }
  }
