  ...
  implements Parcelable
{
    ...
    if ((paramObject != null) && (Build.VERSION.SDK_INT >= 21))
    {
      ...
      if (localList != null)
      {
        ...
        while (localIterator.hasNext())
          localArrayList1.add(CustomAction.fromCustomAction(localIterator.next()));
      ...
      if (i >= 22)
        localBundle1 = PlaybackStateCompatApi22.getExtras(paramObject);
      Bundle localBundle2 = localBundle1;
      PlaybackStateCompat localPlaybackStateCompat = new PlaybackStateCompat(PlaybackStateCompatApi21.getState(paramObject), PlaybackStateCompatApi21.getPosition(paramObject), PlaybackStateCompatApi21.getBufferedPosition(paramObject), PlaybackStateCompatApi21.getPlaybackSpeed(paramObject), PlaybackStateCompatApi21.getActions(paramObject), 0, PlaybackStateCompatApi21.getErrorMessage(paramObject), PlaybackStateCompatApi21.getLastPositionUpdateTime(paramObject), localArrayList2, PlaybackStateCompatApi21.getActiveQueueItemId(paramObject), localBundle2);
  ...
  public Object getPlaybackState()
  {
    if ((this.mStateObj == null) && (Build.VERSION.SDK_INT >= 21))
    {
      ...
      if (localList != null)
      {
        localArrayList1 = new ArrayList(this.mCustomActions.size());
        Iterator localIterator = this.mCustomActions.iterator();
        while (localIterator.hasNext())
          localArrayList1.add(((CustomAction)localIterator.next()).getCustomAction());
      }
      ArrayList localArrayList2 = localArrayList1;
      if (Build.VERSION.SDK_INT >= 22)
        this.mStateObj = PlaybackStateCompatApi22.newInstance(this.mState, this.mPosition, this.mBufferedPosition, this.mSpeed, this.mActions, this.mErrorMessage, this.mUpdateTime, localArrayList2, this.mActiveItemId, this.mExtras);
      else
        this.mStateObj = PlaybackStateCompatApi21.newInstance(this.mState, this.mPosition, this.mBufferedPosition, this.mSpeed, this.mActions, this.mErrorMessage, this.mUpdateTime, localArrayList2, this.mActiveItemId);
    }
  ...
  public static final class Builder
  {
    ...
    {
      PlaybackStateCompat localPlaybackStateCompat = new PlaybackStateCompat(this.mState, this.mPosition, this.mBufferedPosition, this.mRate, this.mActions, this.mErrorCode, this.mErrorMessage, this.mUpdateTime, this.mCustomActions, this.mActiveItemId, this.mExtras);
      return localPlaybackStateCompat;
    }
