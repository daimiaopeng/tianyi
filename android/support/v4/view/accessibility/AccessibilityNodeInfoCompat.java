...
public class AccessibilityNodeInfoCompat
{
  ...
  private boolean getBooleanProperty(int paramInt)
  {
    ...
    if (localBundle == null)
      return false;
    int i = paramInt & localBundle.getInt("androidx.view.accessibility.AccessibilityNodeInfoCompat.BOOLEAN_PROPERTY_KEY", 0);
    boolean bool = false;
    if (i == paramInt)
      bool = true;
    return bool;
  ...
  private void setBooleanProperty(int paramInt, boolean paramBoolean)
  {
    ...
    if (localBundle != null)
    {
      int i = localBundle.getInt("androidx.view.accessibility.AccessibilityNodeInfoCompat.BOOLEAN_PROPERTY_KEY", 0) & (paramInt ^ 0xFFFFFFFF);
      if (!paramBoolean)
        paramInt = 0;
      localBundle.putInt("androidx.view.accessibility.AccessibilityNodeInfoCompat.BOOLEAN_PROPERTY_KEY", paramInt | i);
    }
  }
  ...
  public void setCollectionInfo(Object paramObject)
  {
    if (Build.VERSION.SDK_INT >= 19)
    {
      ...
      if (paramObject == null)
        ...
        localCollectionInfo = (AccessibilityNodeInfo.CollectionInfo)((CollectionInfoCompat)paramObject).mInfo;
  ...
  public void setCollectionItemInfo(Object paramObject)
  {
    if (Build.VERSION.SDK_INT >= 19)
    {
      ...
      if (paramObject == null)
        ...
        localCollectionItemInfo = (AccessibilityNodeInfo.CollectionItemInfo)((CollectionItemInfoCompat)paramObject).mInfo;
  ...
  public String toString()
  {
    ...
    localStringBuilder4.append(isScrollable());
  ...
  public static class AccessibilityActionCompat
  {
    ...
    public static final AccessibilityActionCompat ACTION_HIDE_TOOLTIP = new AccessibilityActionCompat(localAccessibilityAction11);
    ...
    static
    {
      ...
      ACTION_MOVE_WINDOW = new AccessibilityActionCompat(localAccessibilityAction9);
